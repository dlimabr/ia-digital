...
import com.ia.web.app.payload.request.LoginRequest;
import com.ia.web.app.payload.request.SignupRequest;
import com.ia.web.app.payload.response.JwtResponse;
import com.ia.web.app.payload.response.MessageResponse;
import com.ia.web.app.repository.RoleRepository;
import com.ia.web.app.repository.UserRepository;
import com.ia.web.app.security.jwt.JwtUtils;
...
public class AuthController {
    ...
    public ResponseEntity<?> destroySession(HttpServletRequest request) {
        //invalidate the session , this will clear the data from configured database redis
		request.getSession().invalidate();
        return ResponseEntity.ok(new MessageResponse("Sessão invalidada"));
    }
}
